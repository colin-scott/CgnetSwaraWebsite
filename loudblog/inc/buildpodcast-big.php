...
// Bill -- return 25 instead of 10
$result = $GLOBALS['lbdata']->SelectLimit($dosql, 25, 0);
$i = 0;
...
echo "   <itunes:email>shu@cgnet.in</itunes:email>\n";
echo "</itunes:owner>\n";
echo "<managingEditor>shu@cgnet.in</managingEditor>\n";
...
// bill: manually show alert of change of app
//echo "<item><pubDate>Thu, 16 Oct 2014 11:43:50 +0530</pubDate><title>&#2319;&#2325; &#2357;&#2367;&#2358;&#2375;&#2359; &#2360;&#2370;&#2330;&#2344;&#2366;</title><link>http://cgnetswara.org//index.php?id=250</link><guid>http://cgnetswara.org//index.php?id=250</guid><dc:creator>bill</dc:creator><itunes:author>bill</itunes:author><itunes:explicit>no</itunes:explicit><comments>http://cgnetswara.org//index.php?id=48717#comments</comments><itunes:keywords></itunes:keywords><itunes:subtitle></itunes:subtitle><itunes:summary></itunes:summary><description></description><enclosure url=\"http://cgnetswara.org//audio/48717.mp3\" length=\"1048576\" type=\"audio/mpeg\" /><itunes:duration>00:02:03</itunes:duration></item>";
...
foreach ($rows as $fields) { 
	...
	// bill - don't need comments for FeedEx
...
// bill - don't need subtitle or summary from FeedEx
//        echo "    <itunes:subtitle>".$subtitle."</itunes:subtitle>\n";
//        echo "    <itunes:summary>".$itun."</itunes:summary>\n\n";
        echo "    <itunes:subtitle></itunes:subtitle>\n";
        echo "    <itunes:summary></itunes:summary>\n\n";

	if (filled($fields['image_file']) AND filled($fields['image_on']) AND isset($fields['image_on'])) {
             $tempimageurl = $settings['url'] . "/audio/" . $fields['image_file'];
	     $imgtag = '<img src="'.$tempimageurl.'" />';
             $desc = $imgtag . $desc;
	}


//bill: don't need description from FeedEx
        //bodytext
        echo "    <description>";
//        echo "    <description>" . $desc;
        ...
        if (filled($fields['image_file']) AND filled($fields['image_on']) AND isset($fields['image_on'])) {
            ...
            if(isset($fields['image_type'])) {
                $imagetype = $fields['image_type'];
            }
            echo "    <enclosure url=\"$tempimageurl\" ";
            echo "length=\"$imagesize\" ";
            echo "type=\"".$imagetype."\" />\n";
        }
